...
<img src="https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/brussels/comics/images/screenshots.gif" alt="Screenshots of the Comic Book Route Quick App" title="Brussels Comic Book Route Quick App" height="500">
...
You can find all the details of the _Heritage in…_ Quick App project in [its GitHub repository](https://github.com/ow2-miniapp-initiative/poi-miniapp). It comprises three main parts: the __methodology__, the __database__, and the __app__.  
...
<img src="https://github.com/ow2-miniapp-initiative/poi-miniapp/sample/images/methodology-all.jpg" alt="Methodology of Heritage in… Quick App project" width="100%">

### <a name='Step1.cloneandconfiguretheproject'></a>Step 1. clone and configure the project

1. Access the [git repository](https://github.com/ow2-miniapp-initiative/poi-miniapp). 
...
<img src="https://github.com/ow2-miniapp-initiative/poi-miniapp/sample/images/methodology-repo.jpg" alt="File structure of the repository" height="500">
...
Please be sure that this document has the correct format (syntax and content). You can test it locally using any JSON schema validation tool against the JSON schema you can find in the repository ([schema.json](https://github.com/ow2-miniapp-initiative/poi-miniapp/schema.json)). 
...
```js
{
    "meta": {
        ...
        "version": 12,
        "updated": "2022-10-26",
        "source_url": "https://github.com/ow2-miniapp-initiative/poi-miniapp/fr/paris/data.json",
    ...
    "content": {
        "en": {
            "app": {
                ...
                "repository_url": "https://github.com/ow2-miniapp-initiative/poi-miniapp/",
                ...
                "feedback_url": "https://github.com/ow2-miniapp-initiative/poi-miniapp/fr/paris/#contributors",
            ...
            "pois": [
                {
                    ...
                    "name": "Eiffel Tower",
                    "images": [
                        "https://github.com/ow2-miniapp-initiative/poi-miniapp/fr/paris/images/eiffeltower_1.jpg",
                        "https://github.com/ow2-miniapp-initiative/poi-miniapp/fr/paris/images/eiffeltower_2.jpg"
                    ],
...
The [Brussels Comic Book Route Quick App](https://github.com/ow2-miniapp-initiative/poi-miniapp-implementations/tree/main/quick-app/be/brussels/comics) was made through this methodology and templates. The database is based on a dataset by the [BXL Open Data](https://opendata.brussels.be/page/home/) initiative.
...
Read the illustrative [step-by-step guide on how the Brussels Comic Book Route project was created](https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/brussels/comics/step_by_step_development_guide.pdf).
...
<img src="https://github.com/ow2-miniapp-initiative/poi-miniapp/sample/images/methodology-ci.jpg" alt="Summary of the workflow of the CI actions" width="70%">
...
You also can create an issue template to have a homogeneous format (see [.github/ISSUE_TEMPLATE/update_request.md](https://github.com/ow2-miniapp-initiative/poi-miniapp/tree/main/.github/ISSUE_TEMPLATE/update_request.md)) and use it for new issues. 
...
{
    //...
    "issue_url": "https://github.com/ow2-miniapp-initiative/poi-miniapp/issues/new?labels=uk/london&template=update_request.md&title=Update+request+of+"
    //...
}
```
...
<img src="https://github.com/ow2-miniapp-initiative/poi-miniapp/sample/images/methodology-app-maintenance.jpg" alt="How the app works in summary" width="70%">
...
`https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/brussels/comics/data.json`), including the URL in the query string as follows.

```
https://heritagein.info/_/?url=https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/brussels/comics/data.json
``` 
...
We maintain a public [configuration file](https://github.com/ow2-miniapp-initiative/poi-miniapp/blob/main/docs/implementations.json), which the application uses to generate the concrete instances for each configuration file. Each instance listed in this document is a Progressive Web Application. The system generates dedicated [manifest.json](https://developer.mozilla.org/en-US/docs/Web/Manifest) for each of them. 
...
* [Leuven Cultural Heritage](https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/leuven/heritage/). Historical places and monuments in Leuven 🇧🇪. [See result](https://heritagein.info/leuven/).
* [Oeratoom](https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/leuven/oeratoom/). Big Bang Theory artwork in Leuven (🇧🇪). [See result](https://heritagein.info/oeratoom/).
* [Comic Book Route](https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/brussels/comics//). Wall paintings in Brussels (🇧🇪). [See result](https://heritagein.info/comics/).
* [Middelheim Museum](https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/be/antwerpen/middelheimmuseum/data.json). Open-air musseum in Antwerpen (🇩🇪). [See result](https://heritagein.info/middelheim/).
* [Eckernförde Heritage](https://ow2-miniapp-initiative.github.io/poi-miniapp-implementations/de/eckernforde/). Historical buildings in Eckernförde 🇩🇪. [See result](https://heritagein.info/eckernforde/).

Share yours! We are collecting all [the existing implementations in machine-readable format](https://github.com/ow2-miniapp-initiative/poi-miniapp/blob/main/docs/implementations.json). This will help the tools to produce new Web applications based on your database. 

Just update the file or [send us the information](https://github.com/ow2-miniapp-initiative/poi-miniapp/issues/new) about what you have done.

## <a name='License'></a>License

This project's documentation, content, and data folders are licensed under a [CC-BY license](https://github.com/ow2-miniapp-initiative/poi-miniapp/blob/main/LICENSE).

All other code in this repository is licensed under the [MIT license](https://github.com/ow2-miniapp-initiative/poi-miniapp/blob/main/LICENSE-CODE).
...
The code of the quick app is in the [`/quick-app`](https://github.com/ow2-miniapp-initiative/poi-miniapp/tree/main/quick-app) folder of the repository. The web application is in the [poi-miniapp-web repository](https://github.com/ow2-miniapp-initiative/poi-miniapp-web/).

If you don´t know how to start, please login to Github and [raise an issue with your intentions and suggestions](https://github.com/ow2-miniapp-initiative/poi-miniapp/issues/new).
